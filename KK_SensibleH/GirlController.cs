...
namespace KK_SensibleH
{
    ...
    {
        /*
         * All the development goes under assumption of PoV function. 
         * 
         ...
         * 
         * _chaControl.tearsLv
         * Perhaps if I ever go for face. Don't really want to deal with it.
         */
        public void Initialize(int main, float familiarity)
        {
            ...
            _eyeNeckController = this.gameObject.AddComponent<EyeNeckController>();
            _eyeNeckController.Initialize(this, main, _vr, familiarity);
        ...
        internal EyeNeckController _eyeNeckController;
        ...
        {
            _eyeNeckController.OnPositionChange();
